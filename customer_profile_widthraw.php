...
<body>
    ...
    <div class="cont">
        ...
        if (isset($_POST["cnfrm_submit"])) {
            ...
            $sub = (int) $_POST["amount"];
            $sub2= (int) $_POST["crfm_amount"];
            if($sub!=$sub2){
                ...
                if ($sub > $bal) {
                    ...
                    $newbal = (int) $bal - (int) $sub;
                    $f = fopen("./data/" . $dir . "/transaction.txt", 'a');
                    fwrite($f, "\n" . $tdy . "," . "TID" . rand() . "," . "Self Widthraw" . "," . "_" . "," . "$sub" . "," . $newbal);
                    echo '<script>alert("Balance Widthrawn Successfully")</script>';
                }
            }
        }
        ?>
